...
| `RELAY` | Authorized transparent byte-stream forwarding | partial: ordinary two-address TCP relay is executable; HTTP CONNECT and bridge ownership/drain verified; in-process reusable Tailcat adapter verified offline and with a live repeated-stream pairing; Tailcat CLI and two-host wiring pending |
